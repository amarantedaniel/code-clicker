defmodule CodeClickerWeb.ItemControllerTest do
  use CodeClickerWeb.ConnCase

  alias CodeClicker.Store
  alias CodeClicker.Store.Item

  @create_attrs %{base_price: 42, clicks_per_second: 42, name: "some name", price_multiplier: 120.5}
  ...
  describe "create item" do
    test "renders item when data is valid", %{conn: conn} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "base_price" => 42,
        "clicks_per_second" => 42,
        "name" => "some name",
        "price_multiplier" => 120.5}
    end
  ...
  describe "update item" do
    ...
    test "renders item when data is valid", %{conn: conn, item: %Item{id: id} = item} do
      ...
      assert json_response(conn, 200)["data"] == %{
        "id" => id,
        "base_price" => 43,
        "clicks_per_second" => 43,
        "name" => "some updated name",
        "price_multiplier" => 456.7}
    end
